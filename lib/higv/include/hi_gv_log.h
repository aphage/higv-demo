...
* param[in] fileName. CNcomment: 文件名字
* param[in] functionName. CNcomment: 函数名称
* param[in] index current redording's index.CNcomment: 当前记录索引
* param[in] text Get the verbose log info.CNcomment: 输出日志的文本信息
*/
