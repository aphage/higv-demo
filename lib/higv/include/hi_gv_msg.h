...
* param[in] widgetHandle Widget handle.CNcomment:窗口或控件
...
* param[in] widgetHandle Wiget handle.CNcomment:窗口或控件
* param[in] msgId  Messag ID. The msg id is defined in "hi_gv_widget.h"
...
* param[in] widgetHandle Widget handle.CNcomment:窗口或控件
* param[in] msgId  Messag ID. The msg id is defined in "hi_gv_widget.h"
* .CNcomment:消息ID，具体消息定义参考头文件hi_gv_widget.h \param[in] buf  Paramater 1,   the pointer of
