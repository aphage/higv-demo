...
* param[in] inputDevice  Input device function.CNcomment:输入设备注册结构体
* retval ::HI_SUCCESS
...
* param[in] touchCallBack  Touch callback function.CNcomment:钩子函数
* retval ::HI_SUCCESS
* retval ::HI_ERR_COMM_NOTINIT
*/
...
* param[in] scrollThreshold  First trigger value.CNcomment:触发事件的阈值
* retval ::HI_SUCCESS
...
* param[in] isEnable enable tag. CNcomment: 使能标志，HI_TRUE表示使能，HI_FALSE表示禁用。
* retval ::0 success
* retval ::-1 failure
