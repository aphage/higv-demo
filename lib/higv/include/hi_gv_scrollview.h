...
typedef struct hiHIGV_SCROLLVIEW_Init_S {
    HIGV_HANDLE hVerticalScrollBar; /* Bind vertical scrollbar handle; CNcomment: 绑定的垂直滚动条句柄 */
    HIGV_HANDLE hHorizontalScrollbar; /* Bind horizontal scrollbar handle ; CNcomment: 绑定的水平滚动条句柄 */
...
* param[in]  scrollViewHandle Scroll view handle. CNcomment:控件句柄
* param[in]  initAttr The info of scrollview when created. CNcomment:控件创建信息
* retval ::HI_SUCCESS
...
* param[in]  scrollViewHandle Scroll view handle. CNcomment:控件句柄
* param[out] rect Rectangle. CNcomment:矩形输出参数
* retval ::HI_SUCCESS
* retval ::HI_ERR_COMM_LOST
* retval ::HI_ERR_COMM_INVAL
*/
...
* attention \n
    ...
    |_____________________|
* param[in]  scrollViewHandle Scroll view handle. CNcomment:控件句柄
* param[out] cordX X abscissa. CNcomment:x坐标
* param[out] cordY Y abscissa. CNcomment:y坐标
* retval ::HI_SUCCESS
* retval ::HI_ERR_COMM_LOST
* retval ::HI_ERR_COMM_INVAL
*/
...
* param[in]  scrollViewHandle Scroll view handle. CNcomment:控件句柄
* param[in]  handleVertical vertical scrollbar. CNcomment:垂直滚动条
* param[in]  handleHorizontal horizontal scrollbar. CNcomment:水平滚动条
* retval ::HI_SUCCESS
* retval ::HI_ERR_COMM_LOST
* retval ::HI_ERR_COMM_INVAL
*/
