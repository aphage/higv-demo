...
/**
\brief Sets size of a text output object.CNcomment:设置文本输出对象的大小 CNend
\attention \n
\param[in] font_handle Handle of a text output object.CNcomment:文本输出对象句柄 CNend
\param[in] size  size a text output object.CNcomment:文本输出对象的大小，CNend
...
/**
\brief get size of a text output object.CNcomment:获取文本输出对象的大小 CNend
\attention \n
\param[in] font_handle Handle of a text output object.CNcomment:文本输出对象句柄 CNend
\param[in] size  size a text output object.CNcomment:文本输出对象的大小，CNend
