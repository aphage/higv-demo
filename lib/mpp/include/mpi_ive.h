 ...
 * Description: ive mpi header file
...
*                                                   1. U8C3_PACKAGE\U8C3_PLANAR typed for
*                                                       YUV2RGB\YUV2HSV\YUV2LAB;
...
*   Parameters   : IVE_HANDLE                 *pIveHandle     Returned handle ID of a task.
*                  IVE_SRC_IMAGE_S            *pstSrc         Input source data.Only SP420\SP422 type
*                                                              are supported.
*                  IVE_DST_IMAGE_S            *pstDst         Output result.Only U8C3_PACKAGE\U8C3_PLANAR
*                                                              are supported.
...
*   Parameters   : IVE_HANDLE           *pIveHandle      Returned handle ID of a task
*                  IVE_SRC_IMAGE_S      *pstSrc          Input source data. Only the U8C1 input image
*                                                         is supported.
*                  IVE_DST_IMAGE_S      *pstDstH         The (horizontal) result of input image filtered by
*                                                         the input mask;
*                  IVE_DST_IMAGE_S      *pstDstV         The (vertical) result  of input image filtered by
*                                                         the transposed mask;
...
*   Parameters   : IVE_HANDLE              *pIveHandle       Returned handle ID of a task
*                  IVE_SRC_INFO_S          *pstSrc           Input source data. Only the U8C1 input format
*                                                             is supported.
...
*   Parameters   : 5x5 template erode. Only the U8C1 binary image input is supported.
*                   Or else the result is not correct.
...
*   Parameters   : IVE_HANDLE          *pIveHandle   Returned handle ID of a task
*                  IVE_SRC_IMAGE_S     *pstSrc1      Minuend of the input source.Only the U8C1 input format
*                                                     is supported.
*                  IVE_SRC_IMAGE_S     *pstSrc2      Subtrahend of the input source.Only the U8C1 input
*                                                     format is supported.
...
*   Parameters   : IVE_HANDLE           *pIveHandle   Returned handle ID of a task
*                  IVE_SRC_IMAGE_S      *pstSrc       Input source data.Only the U8C1 input format
*                                                      is supported.
*                  IVE_DST_IMAGE_S      *pstDst       Output result.Can be U32C1 or U64C1, relied on the
*                                                      control parameter.
...
*   Parameters   : IVE_HANDLE              *pIveHandle    Returned handle ID of a task
*                  IVE_SRC_IMAGE_S         *pstSrc        Input source data.Only the S16 input format
*                                                          is supported.
*                  IVE_DST_IMAGE_S         *pstDst        Output result.
...
*   Parameters   : IVE_HANDLE                *pIveHandle        Returned handle ID of a task
*                  IVE_SRC_IMAGE_S           *pstSrc            Input source data. Only the U16 input
*                                                                format is supported.
*                  IVE_DST_IMAGE_S           *pstDst            Output result
...
*   Parameters   : IVE_HANDLE                *pIveHandle              Returned handle ID of a task
*                  IVE_SRC_IMAGE_S           *pstSrc                  Input source data.Only U16C1\S16C1
*                                                                      input is supported.
*                  IVE_DST_IMAGE_S           *pstDst                  Output result
...
*   Parameters   : IVE_HANDLE                   *pIveHandle          Returned handle ID of a task
*                  IVE_SRC_IMAGE_S              *pstSrc              Input source data. Only U8C1 input
*                                                                     is supported
*                  IVE_DST_IMAGE_S              *pstDst              Output result
...
*   Parameters   : IVE_HANDLE               *pIveHandle          Returned handle ID of a task
*                  IVE_SRC_IMAGE_S          *pstSrc              Input source.Only U8C1 input format
*                                                                 is supported.
*                  IVE_DST_IMAGE_S          *pstDst              Output result.
...
*   Parameters   : IVE_HANDLE          *pIveHandle      Returned handle ID of a task
*                  IVE_SRC_IMAGE_S     *pstSrc1         Augend of the input source.Only the U8C1 input
*                                                        format is supported.
*                  IVE_SRC_IMAGE_S     *pstSrc2         Addend of the input source.Only the U8C1 input
*                                                        format is supported.
...
*                  IVE_SRC_IMAGE_S     *pstFactor         U16C1 input, low-8bits is sensitivity factor,
*                                                          and high-8bits is life update factor.
*                  IVE_DST_IMAGE_S     *pstFg             Output foreground (Binary) image.
*                  IVE_DST_IMAGE_S     *pstBg             Output background image. With same type of pstSrc.
*                  IVE_DST_IMAGE_S     *pstMatchModelInfo Output U8C1 match model info image.
*                                                          Low-1bit is match flag,and high-7bits is
*                                                          max freq index.
*                  IVE_MEM_INFO_S      *pstModel          Model data.
...
*   Parameters   : IVE_HANDLE                 *pIveHandle           Returned handle ID of a task
*                  IVE_SRC_IMAGE_S            *pstSrc               Input source. Only the U8C1 input
*                                                                    format is supported
...
*   Parameters   : IVE_HANDLE            *pIveHandle        Returned handle ID of a task
*                  IVE_SRC_IMAGE_S       *pstSrc            Input source data
*                  IVE_DST_IMAGE_S       *pstDstH           The (horizontal) result of input image filtered
*                                                            by the input mask
*                  IVE_DST_IMAGE_S       *pstDstV           The (vertical) result  of input image filtered
*                                                            by the transposed mask
*                  IVE_DST_IMAGE_S       *pstDstHV          Output the horizontal and vertical component
*                                                            in single image in package format.
...
*   Parameters   : IVE_HANDLE                     *pIveHandle          Returned handle ID of a task
*                  IVE_SRC_IMAGE_S                astSrcPrevPyr        Prev-frame's pyramid.
*                                                                       Must be U8C1 images.
*                  IVE_SRC_IMAGE_S                astSrcNextPyr        Next-frame's pyramid. Same size and
*                                                                       type with astSrcPrePyr.
*                  IVE_SRC_MEM_INFO_S             *pstPrevPts          Intresting points on astSrcPrePyr[0].
*                  IVE_MEM_INFO_S                 *pstNextPts          Output points. When bUseInitFlow is
*                                                                       true, must have the same size of
*                                                                       pstPrevPts as input.
...
*   Description  : The first part of corners detection using Shi-Tomasi-like method: calculate
*                   candidate corners.
*   Parameters   : IVE_HANDLE                 *pIveHandle             Returned handle ID of a task
*                  IVE_SRC_IMAGE_S            *pstSrc                 Input source data
...
*   Description  : The second part of corners detection using Shi-Tomasi-like method:
*                   select corners by certain rules.
...
*                  IVE_DST_IMAGE_S            *pstBgDiffFg         Foreground image obtained by background
*                                                                   matching, the background pixel value
*                                                                   is 0, the foreground pixel value is
*                                                                   the gray difference value
*                  IVE_DST_IMAGE_S            *pstFrmDiffFg        Foreground image obtained by interframe
*                                                                   difference, the background pixel value
*                                                                   is 0, the foreground pixel value is
*                                                                   the gray difference value
...
*                  IVE_DST_IMAGE_S             *pstChgStaImg            Change state life image,
*                                                                        for still detection
*                  IVE_DST_IMAGE_S             *pstChgStaFg             Change state grayscale image,
*                                                                        for still detection
*                  IVE_DST_IMAGE_S             *pstChgStaLife           Change state foreground image,
*                                                                        for still detection
*                  IVE_DST_MEM_INFO_S          *pstStatData             result status data
...
*                  IVE_DST_IMAGE_S   *pstSad     Output result of sad value.Only the U8C1/U16C1 format is
*                                                 supported.
...
*   Description  : Resize.
*   Parameters   : IVE_HANDLE        *pIveHandle    Returned handle ID of a task
*                  IVE_SRC_IMAGE_S   astSrc[]       The input source.Only the U8C1/U8C3_PLANAR input format
*                                                    is supported.
*                  IVE_DST_IMAGE_S   astDst[]       Output result.Only the U8C1/U8C3_PLANAR format is
*                                                    supported.
...
*   Description  : Perform CNN prediction on input sample(s), and output responses for
*                   corresponding sample(s)
*   Parameters   : IVE_HANDLE      *pIveHandle     Returned handle ID of a task
*                  IVE_SRC_IMAGE_S astSrc[]        Input images array. Only the U8C1 and U8C3_PLANAR input
*                                                   are supported
*                  IVE_CNN_MODEL_S *pstCnnModel    CNN model data
...
*                  IVE_DST_MEM_INFO_S    *pstDst          The prediction about classification label
...
*   Parameters   : IVE_HANDLE             *pIveHandle        Returned handle ID of a task.
*                  IVE_SRC_IMAGE_S        *pstSrc            The input source.Only the U8C1/YUVSP420 input
*                                                             format is supported.
*                  IVE_RECT_U32_S         astRoi[]           Roi array.
*                  IVE_SRC_MEM_INFO_S     astPointPair[]     Point pair array.
*                  IVE_DST_IMAGE_S        astDst[]           Output result.Only the U8C1/YUVSP420/
*                                                             U8C3_PACKAGE format is supported.
...
*   Parameters  :  IVE_KCF_OBJ_LIST_S  *pstObjList The object list.
*                  IVE_KCF_BBOX_S      *pstBbox    The bbox of object.
...
*                   IveHandle of the function. In block mode, the system waits until the function that
*                   is being queried is called. In non-block mode, the current status is queried and
*                   no action is taken.
