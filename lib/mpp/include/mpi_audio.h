...
HI_S32 HI_MPI_AI_GetFrame(AUDIO_DEV AiDevId, AI_CHN AiChn,
    AUDIO_FRAME_S *pstFrm, AEC_FRAME_S *pstAecFrm, HI_S32 s32MilliSec);
...
HI_S32 HI_MPI_AI_SetTalkVqeAttr(AUDIO_DEV AiDevId, AI_CHN AiChn, AUDIO_DEV AoDevId, AO_CHN AoChn,
...
HI_S32 HI_MPI_AI_SetTalkVqeV2Attr(AUDIO_DEV AiDevId, AI_CHN AiChn,
    AUDIO_DEV AoDevId, AO_CHN AoChn, const AI_TALKVQEV2_CONFIG_S *pstVqeConfig);
HI_S32 HI_MPI_AI_GetTalkVqeV2Attr(AUDIO_DEV AiDevId, AI_CHN AiChn, AI_TALKVQEV2_CONFIG_S *pstVqeConfig);

HI_S32 HI_MPI_AI_SetChnAttr(AUDIO_DEV AudioDevId, AI_CHN AiChn, const AI_CHN_ATTR_S *pstAttr);
HI_S32 HI_MPI_AI_GetChnAttr(AUDIO_DEV AudioDevId, AI_CHN AiChn, AI_CHN_ATTR_S *pstAttr);
...
HI_S32 HI_MPI_AO_GetChnDelay(AUDIO_DEV AudioDevId, AO_CHN AoChn, HI_U32 *pu32MilliSec);
