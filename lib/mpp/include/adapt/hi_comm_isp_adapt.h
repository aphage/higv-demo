 ...
 * Description: Function of hi_comm_isp_adapt.h
 * Author: ISP SW
 * Create: 2012/06/28
 */
...
typedef struct {
    ...
    hi_u32 quick_start;  /* RW;Range:[0, 1]; Format:32.0; Indicate ISP Quick Start No distinction vipipe.
                            Only used for Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
    hi_bool  long_frm_int_en;  /* when wdr mode enable/disable long frame pipe interrupt.   */
                               /* Only used for Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
} hi_isp_mod_param;
...
typedef struct {
    ...
    hi_u32  stat_intvl;      /* RW;Range:(0, 0xffffffff];Format:32.0;
...
typedef struct {
    hi_s32 offset[ISP_BAYER_CHN_NUM];   /* RW;Range:[-4095, 4095];Format:12.0; Black level differences between the
                                           offset value */
...
typedef union {
    ...
    struct {
        ...
        hi_u64  bit_bypass_radial_crop    : 1;   /* RW;[15]; Not support for Hi3516CV500/Hi3516DV300/Hi3516AV300/
                                                    Hi3559V200/Hi3556V200 */
        hi_u64  bit_bypass_sharpen        : 1;   /* RW;[16] */
        hi_u64  bit_bypass_local_cac      : 1;   /* RW;[17] */
        hi_u64  bit_bypass_global_cac     : 1;   /* RW;[18]; Not support for Hi3516EV200/
                                                    Hi3516EV300/Hi3518EV300/Hi3516DV200 */
        hi_u64  bit2_chn_select           : 2;   /* RW;[19:20] */
        hi_u64  bit_bypass_ldci           : 1;   /* RW;[21] */
        hi_u64  bit_bypass_pregamma       : 1;   /* RW;[22] */
        hi_u64  bit_bypass_radial_shading : 1;   /* RW;[23]; Only used for Hi3559AV100/Hi3519AV100 */
        hi_u64  bit_bypass_ae_stat_fe     : 1;   /* RW;[24] */
        hi_u64  bit_bypass_ae_stat_be     : 1;   /* RW;[25] */
        hi_u64  bit_bypass_mg_stat        : 1;   /* RW;[26] */
        hi_u64  bit_bypass_de             : 1;   /* RW;[27] ; Only used for Hi3516CV500/Hi3516DV300/Hi3516AV300/
                                                    Hi3559V200/Hi3556V200 */
        hi_u64  bit_bypass_af_stat_fe     : 1;   /* RW;[28] ; Only used for Hi3559AV100/Hi3519AV100 */
        hi_u64  bit_bypass_af_stat_be     : 1;   /* RW;[29] */
        hi_u64  bit_bypass_awb_stat       : 1;   /* RW;[30] ; */
        hi_u64  bit_bypass_clut           : 1;   /* RW;[31] ; Not support for  Hi3516EV200/Hi3516EV300/Hi3518EV300/
                                                    Hi3516DV200 */
        hi_u64  bit_bypass_hlc            : 1;   /* RW;[32] ; Not support for Hi3559AV100/
                                                    Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
        hi_u64  bit_bypass_edge_mark      : 1;   /* RW;[33] ; Not support for Hi3516EV200/
                                                    Hi3516EV300/Hi3518EV300/Hi3516DV200 */
        hi_u64  bit_bypass_rgbir          : 1;   /* RW;[34] ; Only used for Hi3516EV200/Hi3516EV300/Hi3518EV300/
                                                    Hi3516DV200 */
...
typedef struct {
    ...
    hi_u16  force_long_low_thr; /* RW;Range:[0, 0xFFF];Format:12.0; data above this threshold will force to choose
                                   long frame only,not support for Hi3559AV100 */
...
typedef struct {
    hi_u16  fusion_thr[WDR_MAX_FRAME_NUM];    /* RW;Range:[0x0,0x3FFF];Format:14.0;the threshold of the 4 frame */
} hi_isp_fusion_attr;

typedef struct {
    hi_isp_bnr_mode bnr_mode;   /* RW;Range:[0, 1];Format:1.0; enable/disable the bnr of wdr */
    hi_bool short_frame_nr;     /* RW;Range:[0, 1];Format:1.0; enable/disable the bnr of short frame
                                   Only used for Hi3519AV100 */
    hi_u8   short_frame_nr_str; /* RW;Range:[0, 0x3F];Format:8.0;the Level 2 short frame sigma weight of G channel,
                                   Only used for Hi3519AV100 */
    hi_u8   fusion_bnr_str;     /* RW;Range:[0, 0x3F];Format:3.3,Only used for Hi3519AV100 */
    hi_u8   noise_floor[NOISESET_ELENUM]; /* RW;Range:[0x0,0xFF];Format:8.0,Only used for Hi3559AV100/Hi3519AV100 */
    hi_u8   full_mdt_sig_g_wgt;  /* RW;Range:[0, 0x1F];Format:8.0,Only used for Hi3519AV100 */
    hi_u8   full_mdt_sig_rb_wgt; /* RW;Range:[0, 0x1F];Format:8.0,Only used for Hi3519AV100 */
    hi_u8   full_mdt_sig_wgt;    /* RW;Range:[0, 0x1F];Format:8.0,Only used for Hi3559AV100 */
    hi_u8   g_sigma_gain[3];     /* RW;Range:[0, 0xFF];Format:8.0,Only used for Hi3559AV100/Hi3519AV100 */
    hi_u8   rb_sigma_gain[3];    /* RW;Range:[0, 0xFF];Format:8.0,Only used for Hi3559AV100/Hi3519AV100 */
} hi_isp_wdr_bnr_attr;

typedef struct {
    hi_isp_wdr_merge_mode   wdr_merge_mode;
    hi_isp_wdr_combine_attr wdr_combine;
    hi_isp_wdr_bnr_attr     bnr_attr;         /* Only used for Hi3559AV100/Hi3519AV100 */
    hi_isp_fusion_attr      fusion_attr;
    hi_isp_wdr_wb_gain_position wdr_wb_gain_position; /* RW; Range: [0x0, 0x1]; WDR Gain with or without WB Gain.
                                                         Only used for Hi3559AV100 */
} hi_isp_wdr_fs_attr;

typedef struct {
    hi_u16 x;     /* RW; Range:[0, 1000]; Format:10.0; x position of the characteristic point of the cubic curve;
                     Only used for Hi3559AV100 */
    hi_u16 y;     /* RW; Range:[0, 1000]; Format:10.0; y position of the characteristic point of the cubic curve;
                     Only used for Hi3559AV100 */
    hi_u16 slope; /* RW; Range:[0, 10000]; Format:14.0; slope of the characteristic point of the cubic curve;
                     Only used for Hi3559AV100 */
...
typedef struct {
    hi_u16 strength; /* RW; Range:Hi3559AV100 = [0x0, 0xFF] | Hi3519AV100 = [0x0, 0x3FF] | Hi3516CV500 = [0x0, 0x3FF] |
                        Hi3516DV300 = [0x0, 0x3FF] | Hi3516AV300 = [0x0, 0x3FF] | Hi3559V200 = [0x0, 0x3FF] |
                        Hi3556V200 = [0x0, 0x3FF] | Hi3516EV200 = [0x0, 0x3FF] | Hi3516EV300 = [0x0, 0x3FF] |
                        Hi3518EV300 = [0x0, 0x3FF] | Hi3516DV200 = [0x0, 0x3FF];
...
typedef struct {
    ...
    hi_u16 strength_max; /* RW; Range: Hi3559AV100 = [0x0, 0xFF] | Hi3519AV100 = [0x0, 0x3FF] |
                            Hi3516CV500 = [0x0, 0x3FF] | Hi3516DV300 = [0x0, 0x3FF] | Hi3516AV300 = [0x0, 0x3FF] |
                            Hi3559V200 = [0x0, 0x3FF] | Hi3556V200 = [0x0, 0x3FF] | Hi3516EV200 = [0x0, 0x3FF]|
                            Hi3516EV300 = [0x0, 0x3FF] | Hi3518EV300 = [0x0, 0x3FF]| Hi3516DV200 = [0x0, 0x3FF];
                            Maximum DRC strength in Auto mode */
    hi_u16 strength_min; /* RW; Range: Hi3559AV100 = [0x0, 0xFF] | Hi3519AV100 = [0x0, 0x3FF] |
                            Hi3516CV500 = [0x0, 0x3FF] | Hi3516DV300 = [0x0, 0x3FF] | Hi3516AV300 = [0x0, 0x3FF] |
                            Hi3559V200 = [0x0, 0x3FF] | Hi3556V200 = [0x0, 0x3FF]| Hi3516EV200 = [0x0, 0x3FF] |
                            Hi3516EV300 = [0x0, 0x3FF]|Hi3518EV300 = [0x0, 0x3FF]|Hi3516DV200 = [0x0, 0x3FF];
                            Minimum DRC strength in Auto mode */
...
typedef struct {
    ...
    hi_u8  pd_strength;           /* RW; Range:[0x0, 0x80]; Format:8.0; Controls the purple detection strength,
                                      Only used for Hi3559AV100/Hi3519AV100/Hi3516CV500/Hi3516DV300/Hi3516AV300/
                                      Hi3559V200/Hi3556V200 */
    ...
    hi_u8  detail_bright_str;      /* RW; Range:[0x0, 0x80]; Format:8.0; Controls the gain of the non-linear positive
                                      detail enhancement; Only used for Hi3559AV100 */
    hi_u8  detail_dark_str;        /* RW; Range:[0x0, 0x80]; Format:8.0; Controls the gain of the non-linear negative
                                      detail enhancement; Only used for Hi3559AV100 */
    hi_u8  detail_bright_step;     /* RW; Range:[0x0, 0x80]; Format:8.0; Controls the step of the non-linear positive
                                      detail enhancement; Only used for Hi3559AV100 */
    hi_u8  detail_dark_step;       /* RW; Range:[0x0, 0x80]; Format:8.0; Controls the step of the non-linear negative
                                      detail enhancement; Only used for Hi3559AV100 */
    ...
    hi_u8  flt_scale_coarse;     /* RW; Range:[0x0, 0xF]; Format:4.0; Spatial filter scale coarse control;
                                    Only used for Hi3559AV100 and Hi3519AV100 */
    hi_u8  flt_scale_fine;       /* RW; Range:[0x0, 0xF]; Format:4.0; Spatial filter scale fine control;
                                    Only used for Hi3559AV100 and Hi3519AV100  */
    ...
    hi_u8  spatial_flt_coef;     /* RW; Range: Hi3559AV100 = [0x0, 0xA] | Hi3519AV100 = [0x0, 0x5] |
                                    Hi3516CV500 = [0x0, 0x5] | Hi3516DV300 = [0x0, 0x5] | Hi3516AV300 = [0x0, 0x5] |
                                    Hi3559V200 = [0x0, 0x5] | Hi3556V200 = [0x0, 0x5] | Hi3516EV200 = [0x0, 0x5] |
                                    Hi3516EV300 = [0x0, 0x5] |Hi3518EV300 = [0x0, 0x5]|Hi3516DV200 = [0x0, 0x5];
    ...
    hi_u8  dp_detect_range_ratio; /* RW; Range:[0x0, 0x1F]; Format:5.0; DRC defect pixel detection control parameter;
                                     Only used for Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
    hi_u8  dp_detect_thr_slo;     /* RW; Range:[0x0, 0x1F]; Format:5.0; DRC defect pixel detection control parameter;
                                     Only used for Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
    hi_u16 dp_detect_thr_min;     /* RW; Range:[0x0, 0xFFFF]; Format:16.0; DRC defect pixel detection control parameter;
                                     Only used for Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
...
typedef struct {
    hi_u8 wgt;   /* RW;Range:Hi3559AV100 = [0x0, 0x80] | Hi3519AV100 = [0x0, 0x80]| Hi3516CV500 = [0x0, 0xFF] |
                    Hi3516DV300 = [0x0, 0xFF]| Hi3516AV300 = [0x0, 0xFF]|Hi3559V200 = [0x0, 0xFF] |
                    Hi3556V200 = [0x0, 0xFF] | Hi3516EV200 = [0x0, 0xFF] | Hi3516EV300 = [0x0, 0xFF] |
                    Hi3518EV300 = [0x0, 0xFF]| Hi3516DV200 = [0x0, 0xFF];
...
typedef struct {
    ...
    hi_u16                   blc_ctrl[ISP_AUTO_ISO_STRENGTH_NUM]; /* RW;Range: [0x0, 0x1FF];Format:9.0;auto mode,
...
typedef struct {
    ...
    hi_s32  iso_ratio[ISP_AUTO_ISO_STRENGTH_NUM];      /* RW;Range:[0,2047];Format:1.10 */
} hi_isp_ca_lut;

/* Only used for Hi3559AV100/Hi3519AV100 */
typedef struct {
    hi_u8   cp_lut_y[HI_ISP_CA_YRATIO_LUT_LENGTH]; /* RW;Range:[0,255];Format:8.0; */
    hi_u8   cp_lut_u[HI_ISP_CA_YRATIO_LUT_LENGTH]; /* RW;Range:[0,255];Format:8.0; */
    hi_u8   cp_lut_v[HI_ISP_CA_YRATIO_LUT_LENGTH]; /* RW;Range:[0,255];Format:8.0; */
} hi_isp_cp_lut;

typedef struct {
    hi_bool enable;             /* RW;Range:[0x0,0x1];Format:1.0 */
    hi_isp_ca_type ca_cp_en;    /* Only used for Hi3559AV100/Hi3519AV100 */
    hi_isp_ca_lut  ca;
    hi_isp_cp_lut  cp;         /* Only used for Hi3559AV100/Hi3519AV100 */
} hi_isp_ca_attr;

/* CSC */
typedef struct {
    hi_s16 csc_in_dc[ISP_CSC_DC_NUM];   /* RW; Range:[-1024, 1023]; Format: 11.0; Input dc component for csc matrix */
    hi_s16 csc_out_dc[ISP_CSC_DC_NUM];  /* RW; Range:[-1024, 1023]; Format: 11.0; Output dc component for csc matrix */
    hi_s16 csc_coef[ISP_CSC_COEF_NUM];  /* RW; Range:[-4096, 4095]; Format: 5.10; 3x3 coefficients for csc matrix */
} hi_isp_csc_matrx;
...
/* CLUT LUT */
typedef struct {
    hi_u32 lut[HI_ISP_CLUT_LUT_LENGTH];  /* RW; Range: Hi3559AV100 = [0, 4294967295] | Hi3519AV100 = [0x0, 1073741823]|
                                            Hi3516CV500 = [0x0, 1073741823]| Hi3516DV300 = [0x0, 1073741823] |
                                            Hi3516AV300 = [0x0, 1073741823] | Hi3559V200 = [0x0, 1073741823]|
                                            Hi3556V200 = [0x0, 1073741823];
                                            Not support for Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
} hi_isp_clut_lut;
...
typedef struct {
    ...
    hi_isp_static_dp_type static_dp_type; /* RW; Range: [0, 1];Format 1.0;Select static bright/dark defect-pixel
                                             calibration,Not support for Hi3516EV200/Hi3516EV300/Hi3518EV300/
                                             Hi3516DV200 */
    hi_u8  start_thresh;  /* RW; Range: [1, 255]; Format 8.0;Start threshold for static defect-pixel calibraiton,
                             Not support for Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
    hi_u16 count_max;     /* RW; Range:Hi3559AV100 = [0, 8192] | Hi3519AV100 = [0, 8192]| Hi3516CV500 = [0, 6144] |
                             Hi3516DV300 = [0, 6144] | Hi3516AV300 = [0, 6144] |Hi3559V200 = [0, 6144] |
                             Hi3556V200 = [0, 6144];Format 14.0; limited Range: [0, STATIC_DP_COUNT_NORMAL*BlkNum],
                             Limit of max number of static defect-pixel calibraiton.
                             Not support for Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
    hi_u16 count_min;     /* RW; Range:Hi3559AV100 = [0, 8192] | Hi3519AV100 = [0, 8192]| Hi3516CV500 = [0, 6144] |
                             Hi3516DV300 = [0, 6144]| Hi3516AV300 = [0, 6144]| Hi3559V200 = [0, 6144] |
                             Hi3556V200 = [0, 6144];Format 14.0; limited Range: [0, u16CountMax],
    ...
    hi_u16 time_limit;    /* RW; Range: [0x0, 1600];Format 11.0;Time limit for static defect-pixel calibraiton, in
                             frame number,Not support for Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */

    hi_u32 table[STATIC_DP_COUNT_MAX];  /* R; Range: [0, 0x1FFF1FFF];Format 29.0;Static defect-pixel calibraiton table,
    ...
    hi_u8  finish_thresh;   /* R; Range: [0, 255];Format 8.0; Finish threshold for static defect-pixel calibraiton,
                               Not support for Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
    hi_u16 count;          /* R; Range:Hi3559AV100 = [0, 8192] | Hi3519AV100 = [0, 8192] Hi3516CV500 = [0, 6144]|
                              Hi3516DV300 = [0, 6144]| Hi3516AV300 = [0, 6144]| Hi3559V200 = [0, 6144] |
                              Hi3556V200 = [0, 6144];Format 14.0; Finish number for static defect-pixel calibraiton
                              Not support for Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
...
typedef struct {
    hi_bool enable;       /* RW; Range: [0, 1];Format 1.0;Enable/disable the static defect-pixel module,
                             Not support for Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
    hi_u16  bright_count; /* RW; Range:Hi3559AV100 = [0, 8192] | Hi3519AV100 = [0, 8192]| Hi3516CV500 = [0, 6144]|
                             Hi3516DV300 = [0, 6144]| Hi3516AV300 = [0, 6144]| Hi3559V200 = [0, 6144] |
                             Hi3556V200 = [0, 6144];Format 14.0;limited Range: [0, STATIC_DP_COUNT_NORMAL*BlkNum],
                             ...
                             Not support for Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
    hi_u16  dark_count;   /* RW; Range:Hi3559AV100 = [0, 8192] | Hi3519AV100 = [0, 8192]| Hi3516CV500 = [0, 6144]|
                             Hi3516DV300 = [0, 6144]| Hi3516AV300 = [0, 6144]|Hi3559V200 = [0, 6144] |
                             Hi3556V200 = [0, 6144];Format 14.0;limited Range: [0, STATIC_DP_COUNT_NORMAL*BlkNum],
                             When used as input(W), indicate the number of static dark defect pixels;
                             As output(R), invalid value 0.
                             Not support for Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
    hi_u32  bright_table[STATIC_DP_COUNT_MAX]; /* RW; Range: [0x0, 0x1FFF1FFF];Format 29.0;
                                                  0~12 bits represents the X coordinate of the defect pixel,
                                                  16~28 bits represent the Y coordinate of the defect pixel
    ...
    hi_u32  dark_table[STATIC_DP_COUNT_MAX]; /* RW; Range: [0x0, 0x1FFF1FFF];Format 29.0;
                                                0~12 bits represents the X coordinate of the defect pixel,
                                                16~28 bits represent the Y coordinate of the defect pixel
...
typedef struct {
    hi_bool enable; /* RW; Range: [0, 1];Format 1.0;Enable/disable dis module,
...
typedef struct {
    ...
    hi_u16  mesh_str;    /* RW; Range:Hi3559AV100=[0, 65535]| Hi3519AV100=[0, 65535]|Hi3516CV500=[0, 65535]|
                            Hi3516DV300=[0, 65535]|Hi3516AV300=[0, 65535]| Hi3559V200=[0, 65535]|
                            Hi3556V200=[0, 65535] | Hi3516EV200 = [0x0, 1023] | Hi3516EV300 = [0x0,1023] |
                            Hi3518EV300 = [0x0,1023] | Hi3516DV200 = [0x0,1023];
...
typedef struct {
    ...
    hi_u16  x_grid_width[HI_ISP_MLSC_X_HALF_GRID_NUM]; /* RW; Range:Hi3559AV100=[4, 1988]| Hi3519AV100=[4, 1988]|
                                                            Hi3516CV500=[4, 1092]|Hi3516DV300=[4, 1092]|
                                                            Hi3516AV300=[4, 1092]|Hi3559V200=[4, 1092]|
                                                            Hi3556V200=[4, 1092] | Hi3516EV200 = [4,255]|
                                                            Hi3516EV300 = [4,255]|Hi3518EV300 = [4,255]|
                                                            Hi3516DV200 = [4,255]; limited Range:[4, u32Width/4 - 60],
                                                          Member used to store the width data of each GRID partition */
    hi_u16  y_grid_width[HI_ISP_MLSC_Y_HALF_GRID_NUM]; /* RW; Range:Hi3559AV100=[4, 1988]| Hi3519AV100=[4, 1988]|
                                                            Hi3516CV500=[4, 1092]|Hi3516DV300=[4, 1092]|
                                                            Hi3516AV300=[4, 1092]|Hi3559V200=[4, 1092]|
                                                            Hi3556V200=[4, 1092]|Hi3516EV200 = [4,255]|
                                                            Hi3516EV300 =[4,255]| Hi3518EV300 = [4,255 ]|
                                                            Hi3516DV200 = [4,255 ]; limited Range:[4, u32Height/4 - 60];
...
typedef struct {
    hi_u8   mesh_scale;       /* RW; Range:[0, 7];Format:3.0;Three bit value that selects the scale and precision for
                                 the 10 bit gain coefficients stored in mesh tables */
    hi_u16  x_grid_width[HI_ISP_MLSC_X_HALF_GRID_NUM]; /* RW; Range:Hi3559AV100=[4, 16323]| Hi3519AV100=[4, 16323]|
                                                     Hi3516CV500=[4, 16323]|Hi3516DV300=[4, 16323]|
                                                     Hi3516AV300=[4, 16323] | Hi3559V200=[4, 16323]|
                                                     Hi3556V200=[4, 16323]|Hi3516EV200 = [4,255]|
                                                     Hi3516EV300 =[4,255]| Hi3518EV300 = [4,255]|
                                                     Hi3516DV200 = [4,255]; limited Range:[4, u16ImgWidth /4 - 60],
                                                     Member used to store the width data of each GRID partition */
    hi_u16  y_grid_width[HI_ISP_MLSC_Y_HALF_GRID_NUM]; /* RW; Hi3559AV100=[4, 16323]| Hi3519AV100=[4, 16323]|
                                                     Hi3516CV500=[4, 16323]|Hi3516DV300=[4, 16323]|
                                                     Hi3516AV300=[4, 16323]| Hi3559V200=[4, 16323] |
                                                     Hi3556V200=[4, 16323]|Hi3516EV200 = [4,255]|
                                                     Hi3516EV300 =[4,255]| Hi3518EV300 = [4,255 ]|
                                                     Hi3516DV200 = [4,255]; limited Range:[4, u16ImgHeight /4 - 60],
                                                     Member used to store the height data of each GRID partition */
...
typedef struct {
    hi_u16  r_gain[HI_ISP_RLSC_POINTS];  /* RW; Range:[0, 65535];Member used to store the calibration data of the
                                            R channel required for RLSC.Only used for Hi3559AV100/Hi3519AV100 */
    hi_u16  gr_gain[HI_ISP_RLSC_POINTS]; /* RW; Range:[0, 65535];Member used to store the calibration data of the
                                            Gr channel required for RLSC.Only used for Hi3559AV100/Hi3519AV100 */
    hi_u16  gb_gain[HI_ISP_RLSC_POINTS]; /* RW; Range:[0, 65535];Member used to store the calibration data of the
                                            Gb channel required for RLSC.Only used for Hi3559AV100/Hi3519AV100 */
    hi_u16  b_gain[HI_ISP_RLSC_POINTS];  /* RW; Range:[0, 65535];Member used to store the calibration data of the
                                            B channel required for RLSC.Only used for Hi3559AV100/Hi3519AV100 */
} hi_isp_radial_shading_gain_lut;

/* Only used for Hi3559AV100/Hi3519AV100 */
typedef struct {
    hi_operation_mode light_mode;  /* RW; Range:[0, 1];Format:1.0; 1: manual mode; 0: auto mode */
...
typedef struct {
    ...
    hi_isp_radial_shading_gain_lut rlsc_gain_lut; /* Only used for Hi3559AV100/Hi3519AV100 */
...
typedef struct {
    hi_u8   chroma_str[ISP_BAYER_CHN_NUM]; /* RW;Range:[0, 3];Format:2.0;
                                              Strength of Chrmoa noise reduction for R/Gr/Gb/B channel,
                                              Not support for Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
    hi_u8   fine_str;                      /* RW;Range:[0, 0x80];Format:8.0;Strength of Luma noise reduction */
    hi_u16  coring_wgt;                    /* RW;Range:[0, 0xc80];Format:12.0;Strength of reserving the random noise */
    hi_u16  coarse_str[ISP_BAYER_CHN_NUM]; /* RW;Range:[0, 0x360];Format:10.0; Coarse Strength of noise reduction */
} hi_isp_nr_manual_attr;

typedef struct {
    hi_u8   chroma_str[ISP_BAYER_CHN_NUM][ISP_AUTO_ISO_STRENGTH_NUM];  /* RW;Range:[0, 3];Format:2.0;
                                                                          Strength of chrmoa noise reduction for
                                                                          R/Gr/Gb/B channel,
                                                                          Not support for Hi3516EV200/Hi3516EV300/
                                                                          Hi3518EV300/Hi3516DV200 */
    hi_u8   fine_str[ISP_AUTO_ISO_STRENGTH_NUM];                      /* RW;Range:[0, 0x80];Format:8.0;
                                                                         Strength of luma noise reduction */
    hi_u16  coring_wgt[ISP_AUTO_ISO_STRENGTH_NUM];                    /* RW;Range:[0, 0xc80];Format:12.0;
                                                                         Strength of reserving the random noise */
    hi_u16  coarse_str[ISP_BAYER_CHN_NUM][ISP_AUTO_ISO_STRENGTH_NUM]; /* RW;Range:[0, 0x360];Format:10.0;
                                                                         Coarse Strength of noise reduction */
} hi_isp_nr_auto_attr;

typedef struct {
    hi_u8 wdr_frame_str[WDR_MAX_FRAME_NUM];    /* RW;Range:[0, 0x50];Format:7.0; Strength of each frame in wdr mode */
    hi_u8 fusion_frame_str[WDR_MAX_FRAME_NUM]; /* RW;Range:[0, 0x50];Format:7.0; Strength of each frame in wdr mode.
                                                  Only used for Hi3516CV500/Hi3516DV300/Hi3516AV300/Hi3559V200/
                                                  Hi3556V200/Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
} hi_isp_nr_wdr_attr;

typedef struct {
    hi_bool  enable;               /* RW;Range:[0, 1];Format:1.0; Nr Enable */
    hi_bool  low_power_enable;     /* RW;Range:[0, 1];Format:1.0; Nr Low Power Enable.
                                      Not support for Hi3516CV500/Hi3516DV300/Hi3516AV300/Hi3559V200/Hi3556V200/
                                      Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
    ...
    hi_u8    nr_lsc_ratio;         /* RW;Range:[0, 0xff];Format:8.0; Ratio of referring to lens shading.
                                      Not support for Hi3516CV500/Hi3516DV300/Hi3516AV300/Hi3559V200/Hi3556V200/
                                      Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
...
/* Only used for Hi3516CV500/Hi3516DV300/Hi3516AV300/Hi3559V200/Hi3556V200 */
typedef struct {
    hi_u16       global_gain[ISP_AUTO_ISO_STRENGTH_NUM]; /* RW;Range:[0x0, 0x100];Format:1.8 */
    hi_u16       gain_lf[ISP_AUTO_ISO_STRENGTH_NUM];     /* RW;Range:[0x0, 0x20];Format:2.4 */
    hi_u16       gain_hf[ISP_AUTO_ISO_STRENGTH_NUM];     /* RW;Range:[0x0, 0x20];Format:2.4 */
} hi_isp_de_auto_attr;
...
/* Only support Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
typedef struct {
    hi_bool                enable;          /* RW;Range:[0x0,0x1];Format:1.0; Enable/Disable RGBIR module */
    hi_isp_ir_bayer_format in_pattern;      /* RW;Range:[0x0,0x7];Format:3.0; IR pattern of the input signal */
    hi_isp_bayer_format    out_pattern;     /* RW;Range:[0x0,0x3];Format:2.0; Bayer pattern of the output signal */

    hi_u16                 exp_ctrl[ISP_EXP_CTRL_NUM]; /* RW;Range:[0, 2047];Format:11.0;
                                                          Over expose control parameter */
    hi_u16                 gain[ISP_EXP_CTRL_NUM];     /* RW;Range:[0, 511];Format:9.0; Over expose control parameter */

    hi_isp_ir_cvtmat_mode ir_cvt_mat_mode;
    hi_s16                cvt_matrix[ISP_CVTMAT_NUM]; /* RW;Range:[-32768, 32767];Format:s15.0; RGBIR to Bayer image
                                                         Convert matrix coefficients(need calibration) */
} hi_isp_rgbir_attr;
...
typedef struct {
    ...
    hi_u32  table[PREGAMMA_NODE_NUM]; /* RW; Range:Hi3559AV100 = [0, 0x100000] | Hi3519AV100 = [0, 0x100000] |
                                         Hi3516CV500 = [0, 0xFFFFF] |Hi3516DV300 = [0, 0xFFFFF] |
                                         Hi3516AV300 = [0, 0xFFFFF] |Hi3559V200 = [0, 0xFFFFF] |
                                         Hi3556V200 = [0, 0xFFFFF] |Hi3516EV200 = [0x0, 0xFFFFF]|
                                         Hi3516EV300 = [0x0, 0xFFFFF]|Hi3518EV300 = [0x0,0xFFFFF]|
                                         Hi3516DV200 = [0x0,0xFFFFF]; Format:21.0;
                                         PreGamma LUT nodes value */
} hi_isp_pregamma_attr;

typedef struct {
    hi_bool enable;    /* RW; Range:[0, 1]; Format:1.0;Enable/Disable PreLogLUT Function.
                          Not support for Hi3516CV500/Hi3516DV300/Hi3516AV300/Hi3559V200/Hi3556V200 */
} hi_isp_preloglut_attr;

typedef struct {
    hi_bool enable;    /* RW; Range:[0, 1]; Format:1.0;Enable/Disable LogLUT Function.
                          Not support for Hi3516CV500/Hi3516DV300/Hi3516AV300/Hi3559V200/Hi3556V200 */
} hi_isp_loglut_attr;

typedef struct {
    hi_u8  luma_wgt[ISP_SHARPEN_LUMA_NUM]; /* RW; Range: Hi3559AV100 =[0, 127]|Hi3519AV100=[0, 127]|
                                               Hi3516CV500 = [0, 127]|Hi3516DV300 =[0, 127]| Hi3516AV300 =[0, 127]|
                                               Hi3559V200 = [0, 127]| Hi3556V200 =[0, 127]| Hi3516EV200 = [0x0, 31]|
                                               Hi3516EV300 = [0x0, 31]|Hi3518EV300 = [0x0, 31]|Hi3516DV200 = [0x0, 31];
                                               Format:0.7;Adjust the sharpen strength according to luma.
                                               Sharpen strength will be weaker when it decrease. */
    hi_u16 texture_str[ISP_SHARPEN_GAIN_NUM]; /* RW; Range: [0, 4095]; Format:7.5;Undirectional sharpen strength for
                                                 texture and detail enhancement */
    hi_u16 edge_str[ISP_SHARPEN_GAIN_NUM];    /* RW; Range: [0, 4095]; Format:7.5;
    ...
    hi_u8  shoot_sup_str;      /* RW; Range: [0, 255]; Format:8.0;overshoot and undershoot suppression strength, the
    ...
    hi_u8  detail_ctrl_thr;    /* RW; Range: [0, 255]; Format:8.0; The threshold of DetailCtrl, it is used to
    ...
    hi_u8  weak_detail_gain;   /* RW; Range: [0, 127]; Only support for Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200;
                                  sharpen Gain for weakdetail */
} hi_isp_sharpen_manual_attr;

typedef struct {
    hi_u8  luma_wgt[ISP_SHARPEN_LUMA_NUM][ISP_AUTO_ISO_STRENGTH_NUM];  /* RW; Range:Hi3559AV100 =[0, 127]|
                                                                        Hi3519AV100=[0, 127]|Hi3516CV500 = [0, 127]|
                                                                        Hi3516DV300 =[0, 127]|  Hi3516AV300 =[0, 127]|
                                                                        Hi3559V200 = [0, 127] |Hi3556V200 = [0, 127]|
                                                                        Hi3556V200 =[0, 127]| Hi3516EV200 = [0x0, 31]|
                                                                        Hi3516EV300 = [0x0, 31]|Hi3518EV300 = [0x0, 31]|
                                                                        Hi3516DV200 = [0x0, 31]; Format:0.7;
                                                                        Adjust the sharpen strength according to luma.
                                                                    Sharpen strength will be weaker when it decrease */
    hi_u16 texture_str[ISP_SHARPEN_GAIN_NUM][ISP_AUTO_ISO_STRENGTH_NUM];  /* RW; Range: [0, 4095]; Format:7.5;
                                                                             Undirectional sharpen strength for texture
                                                                             and detail enhancement */
    hi_u16 edge_str[ISP_SHARPEN_GAIN_NUM][ISP_AUTO_ISO_STRENGTH_NUM]; /* RW; Range: [0, 4095]; Format:7.5; Directional
                                                                         sharpen strength for edge enhancement */
    hi_u16 texture_freq[ISP_AUTO_ISO_STRENGTH_NUM];   /* RW; Range: [0, 4095]; Format:6.6;Texture frequency adjustment.
                                                         Texture and detail will be finer when it increase */
    hi_u16 edge_freq[ISP_AUTO_ISO_STRENGTH_NUM];      /* RW; Range: [0, 4095]; Format:6.6;Edge frequency adjustment.
                                                         Edge will be narrower and thiner when it increase */
    ...
    hi_u8  shoot_sup_str[ISP_AUTO_ISO_STRENGTH_NUM];  /* RW; Range: [0, 255]; Format:8.0;overshoot and undershoot
                                                         suppression strength, the amplitude and width of shoot will be
                                                         decrease when shootSupSt increase */
    hi_u8  shoot_sup_adj[ISP_AUTO_ISO_STRENGTH_NUM];  /* RW; Range: [0, 15]; Format:4.0;overshoot and undershoot
                                                   suppression adjusting, adjust the edge shoot suppression strength */
    hi_u8  detail_ctrl[ISP_AUTO_ISO_STRENGTH_NUM];    /* RW; Range: [0, 255]; Format:8.0;Different sharpen strength for
                                                         detail and edge. When it is bigger than 128, detail sharpen
                                                         strength will be stronger than edge. */
    hi_u8  detail_ctrl_thr[ISP_AUTO_ISO_STRENGTH_NUM]; /* RW; Range: [0, 255]; Format:8.0; The threshold of DetailCtrl,
                                                          it is used to distinguish detail and edge. */
    hi_u8  edge_filt_str[ISP_AUTO_ISO_STRENGTH_NUM];   /* RW; Range: [0, 63]; Format:6.0;
                                                          The strength of edge filtering. */
    hi_u8  edge_filt_max_cap[ISP_AUTO_ISO_STRENGTH_NUM]; /* RW; Range: [0, 47]; Format:6.0;
    ...
    hi_u8  weak_detail_gain[ISP_AUTO_ISO_STRENGTH_NUM]; /* RW; Range: [0, 127]; Format:7.0;
...
/* Not support for Hi3559AV100/Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
typedef struct {
...
typedef struct {
    ...
    hi_u8    slope;       /* RW; Range: Hi3559AV100 = [0, 14] | Hi3519AV100 = [0, 14]|Hi3516CV500 = [0, 14]|
                             Hi3516DV300 =[0, 14] |Hi3516AV300 =[0, 14] | Hi3559V200 =[0, 14] |Hi3556V200 =[0, 14] |
                             Hi3516EV200 = [0,16]|Hi3516EV300 = [0,16]|Hi3518EV300 = [0,16]|Hi3516DV200 = [0,16];
                             Crosstalk slope value. */
    hi_u8    sensi_slope;  /* RW; Range: Hi3559AV100 = [0, 14] | Hi3519AV100 = [0, 14]|Hi3516CV500 = [0, 14]|
                              Hi3516DV300 =[0, 14]||Hi3516AV300 =[0, 14] | Hi3559V200 =[0, 14] |Hi3556V200 =[0, 14] |
                              Hi3516EV200 = [0,16]|Hi3516EV300 = [0,16]|Hi3518EV300 = [0,16]|Hi3516DV200 = [0,16];
                              Crosstalk sensitivity. */
    hi_u16   sensi_thr;   /* RW; Range: Hi3559AV100 = [0, 16383] | Hi3519AV100 = [0, 16383]|Hi3516CV500 = [0, 16383]|
                             Hi3516DV300 =[0, 16383]|Hi3516AV300 =[0, 16383]| Hi3559V200 =[0, 16383]|
                             Hi3556V200 =[0, 16383]|Hi3516EV200 = [0,65535]|Hi3516EV300 = [0,65535]|
                             Hi3518EV300 = [0,65535]|Hi3516DV200 = [0,65535]; Crosstalk sensitivity threshold. */
    hi_u16   strength[ISP_AUTO_ISO_STRENGTH_NUM];   /* RW; Range: [0,256];Crosstalk strength value. */
    hi_u16   threshold[ISP_AUTO_ISO_STRENGTH_NUM];  /* RW; Range: Hi3559AV100 = [0, 16383] | Hi3519AV100 = [0, 16383]|
                                                       Hi3516CV500 = [0, 16383]|Hi3516DV300 =[0, 16383] |
                                                       Hi3516AV300 =[0, 16383]|Hi3559V200 =[0, 16383] |
                                                       Hi3556V200 =[0, 16383] |Hi3516EV200 = [0,65535]|
                                                       Hi3516EV300 = [0,65535]|Hi3518EV300 = [0,65535]|
                                                       Hi3516DV200 = [0,65535]; Crosstalk threshold. */
    hi_u16   np_offset[ISP_AUTO_ISO_STRENGTH_NUM];   /* RW; Range: Hi3559AV100 = [512, 16383] |
                                                        Hi3519AV100 = [512, 16383]|Hi3516CV500 = [512, 16383]|
                                                        Hi3516DV300 =[512, 16383] |Hi3516AV300 =[512, 16383] |
                                                        Hi3559V200 =[512, 16383] |Hi3556V200 =[512, 16383] |
                                                        Hi3516EV200 = [8192,65535]|Hi3516EV300 = [8192,65535]|
                                                        Hi3518EV300 = [8192,65535]|Hi3516DV200 = [8192,65535];
...
typedef struct {
    ...
    hi_u8   non_dir_mf_detail_ehc_str; /* RW; Range:Hi3559AV100 = [0x0, 0x10] |Hi3519AV100 = [0x0, 0x7f] |
                                          Hi3516CV500= [0x0, 0x7f]|Hi3516DV300= [0x0, 0x7f]| Hi3516AV300= [0x0, 0x7f]|
                                          Hi3559V200= [0x0, 0x7f]|Hi3556V200= [0x0, 0x7f]| Hi3516EV200 = [0x0, 0x7f]|
                                          Hi3516EV300 = [0x0, 0x7f]|Hi3518EV300 = [0x0, 0x7f]|Hi3516DV200 = [0x0, 0x7f];
                                          Format:3.4; Non-direction medium frequent detail enhance  strength */
    hi_u8   non_dir_hf_detail_ehc_str; /* RW; Range:[0x0, 0x10]; Format:2.2;
                                          Non-direction high frequent detail enhance strength */
    hi_u8   detail_smooth_range;    /* RW; Range:Hi3559AV100 = [0x1, 0x8] |Hi3519AV100 = [0x1, 0x7] |
                                       Hi3516CV500 = [0x1, 0x7]|Hi3516DV300 = [0x1, 0x7]| Hi3516AV300 = [0x1, 0x7]|
                                       Hi3559V200 = [0x1, 0x7]|Hi3556V200 = [0x1, 0x7] | Hi3516EV200 = [0x1, 0x7]|
                                       Hi3516EV300 = [0x1, 0x7]|Hi3518EV300 = [0x1, 0x7]|Hi3516DV200 = [0x1, 0x7];
                                       Format:4.0; Detail smooth range */
    hi_u16  detail_smooth_str;     /* RW;Range:[0x0, 0x100]; Format:9.0; Strength of detail smooth,
                                      Only used for Hi3559AV100 */
    hi_u8   color_noise_ctrl_thdf; /* RW;Range:[0x0,0xff]; Format:8.0; Threshold of color noise cancel */
    hi_u8   color_noise_ctrl_strf; /* RW;Range:[0x0, 0x8]; Format:4.0; Strength of color noise cancel,
                                      Not available for Hi3559AV100 */
    hi_u8   color_noise_ctrl_thdy; /* RW;Range:Hi3559AV100 = [0x0, 0xFF] |Hi3519AV100 = [0x0, 0xFF] |
                                      Hi3516CV500 = [0x0, 0xFF] |Hi3516DV300 = [0x0, 0xFF] | Hi3516AV300 = [0x0, 0xFF] |
                                      Hi3559V200 = [0x0, 0xFF] | Hi3556V200 = [0x0, 0xFF] |Hi3516EV200 = [0x0, 0xF] |
    ...
    hi_u8   color_noise_ctrl_stry; /* RW;Range:Hi3559AV100 = [0x0, 0xFF] |Hi3519AV100 = [0x0, 0xFF] |
                                      Hi3516CV500 = [0x0, 0xFF] |Hi3516DV300 = [0x0, 0xFF] | Hi3516AV300 = [0x0, 0xFF] |
                                      Hi3559V200 = [0x0, 0xFF] | Hi3556V200 = [0x0, 0xFF] |Hi3516EV200 = [0x0, 0x3F] |
...
typedef struct {
    ...
    hi_u8   non_dir_mf_detail_ehc_str[ISP_AUTO_ISO_STRENGTH_NUM]; /* RW; Range:Hi3559AV100 = [0x0, 0x10] |
                                                                   Hi3519AV100 = [0x0, 0x7f] |Hi3516CV500= [0x0, 0x7f]|
                                                                   Hi3516DV300= [0x0, 0x7f]|Hi3516AV300= [0x0, 0x7f]|
                                                                   Hi3559V200 = [0x0, 0x7f] |Hi3556V200= [0x0, 0x7f] |
                                                                   Hi3516EV200= [0x0, 0x7f]|Hi3516EV300 = [0x0, 0x7f] |
                                                                   Hi3518EV300= [0x0, 0x7f]|Hi3516DV200 = [0x0, 0x7f];
                                                                   Format:3.4; Non-direction medium frequent detail
                                                                   enhance strength */
    hi_u8   non_dir_hf_detail_ehc_str[ISP_AUTO_ISO_STRENGTH_NUM]; /* RW; Range:[0x0, 0x10]; Format:2.2; Non-direction
                                                                     high frequent detail enhance strength */
    hi_u8   detail_smooth_range[ISP_AUTO_ISO_STRENGTH_NUM];    /* RW; Range:Hi3559AV100 = [0x1, 0x8] |
                                                                  Hi3519AV100 = [0x1, 0x7] |Hi3516CV500 = [0x1, 0x7]|
                                                                  Hi3516DV300 = [0x1, 0x7]|Hi3516AV300 = [0x1, 0x7]|
                                                                  Hi3559V200 = [0x1, 0x7] |Hi3556V200 = [0x1, 0x7]|
                                                                  Hi3516EV200= [0x1, 0x7]|Hi3516EV300 = [0x, 0x7] |
                                                                  Hi3518EV300= [0x1, 0x7]|Hi3516DV200= [0x1, 0x7] ;
                                                                  Format:4.0; Detail smooth range */
    hi_u16  detail_smooth_str[ISP_AUTO_ISO_STRENGTH_NUM];     /* RW;Range:[0x0, 0x100]; Format:9.0;
                                                                 Strength of detail smooth,Only used for Hi3559AV100 */
    hi_u8   color_noise_ctrl_thdf[ISP_AUTO_ISO_STRENGTH_NUM]; /* RW;Range:[0x0, 0xff]; Format:8.0;
                                                                 Threshold of color noise cancel */
    hi_u8   color_noise_ctrl_strf[ISP_AUTO_ISO_STRENGTH_NUM]; /* RW;Range:[0x0, 0x8]; Format:4.0; Strength of color
                                                                 noise cancel, Not available for Hi3559AV100 */
    hi_u8   color_noise_ctrl_thdy[ISP_AUTO_ISO_STRENGTH_NUM];  /* RW;Range:Hi3559AV100 = [0x0, 0xFF] |
                                                                 Hi3519AV100 = [0x0, 0xFF] | Hi3516CV500 = [0x0, 0xFF] |
                                                                 Hi3516DV300 = [0x0, 0xFF] | Hi3516AV300 = [0x0, 0xFF] |
                                                                 Hi3559V200 = [0x0, 0xFF] | Hi3556V200 = [0x0, 0xFF] |
                                                                 Hi3516EV200 = [0x0, 0xF] | Hi3516EV300 = [0x0, 0xF] |
                                                                 Hi3518EV300 = [0x0, 0xF]; Format:8.0; Range of color
                                                                 denoise luma, related to luminance and saturation */
    hi_u8   color_noise_ctrl_stry[ISP_AUTO_ISO_STRENGTH_NUM];  /* RW;Range:Hi3559AV100 = [0x0, 0xFF] |
                                                                Hi3519AV100 = [0x0, 0xFF] | Hi3516CV500 = [0x0, 0xFF] |
                                                                Hi3516DV300 = [0x0, 0xFF] | Hi3516AV300 = [0x0, 0xFF] |
                                                                Hi3559V200 = [0x0, 0xFF] | Hi3556V200 = [0x0, 0xFF] |
                                                                Hi3516EV200 = [0x0, 0x3F] | Hi3516EV300 = [0x0, 0x3F] |
                                                                Hi3518EV300 = [0x0, 0x3F]; Format:8.0;Format:8.0;
...
typedef struct {
    hi_isp_op_type op_type;
    hi_u16         black_level[ISP_BAYER_CHN_NUM]; /* RW; Range: [0x0, 0xFFF];Format:12.0;
...
typedef struct {
    ...
    hi_u32              offset[VI_MAX_SPLIT_NODE_NUM]; /* RW;Range:[0, 0xFFF];Format:12.0;
...
typedef struct {
    ...
    hi_u8    dehaze_lut[DEHAZE_LUT_SIZE];
    hi_isp_op_type      op_type;
...
typedef struct {
    hi_u8 de_purple_cr_str[ISP_EXP_RATIO_STRENGTH_NUM]; /* RW;Range: [0, 8];Format:4.0;
                                                           Correction strength of the R channel */
    hi_u8 de_purple_cb_str[ISP_EXP_RATIO_STRENGTH_NUM]; /* RW;Range: [0, 8];Format:4.0;
...
typedef struct {
    ...
    hi_u16  r_det_thr[ISP_LCAC_DET_NUM];   /* RW;Range: [0,4095];Format:12.0;Component R detection threshold */
    hi_u16  g_det_thr[ISP_LCAC_DET_NUM];   /* RW;Range: [0,4095];Format:12.0;Component G detection threshold */
    hi_u16  b_det_thr[ISP_LCAC_DET_NUM];   /* RW;Range: [0,4095];Format:12.0;Component B detection threshold */
    hi_u16  luma_det_thr[ISP_LCAC_DET_NUM];  /* RW;Range: [0,4095];Format:12.0;Component Luma detection threshold */
    hi_s16  cbcr_ratio[ISP_LCAC_DET_NUM];  /* RW;Range: [-2048,2047];Format:S12.0; Cb/Cr ratio threshold */
...
typedef struct {
    hi_bool  enable;       /* RW;Range:[0, 1];Format:1.0; enable/disable ridial crop.
                              Not support for Hi3516CV500/Hi3516DV300/Hi3516AV300/Hi3559V200/Hi3556V200 */
    hi_point center_coor;  /* RW;the coordinate of central pixel.
                              Not support for Hi3516CV500/Hi3516DV300/Hi3516AV300/Hi3559V200/Hi3556V200 */
    hi_u32   radius;       /* RW;Range:[0, 11586];Format:14.0; when the distance to central pixel is greater than
...
typedef struct {
    hi_u16 texture_str[ISP_SHARPEN_GAIN_NUM];  /* RW; range: [0, 4095]; Format:7.5;Undirectional sharpen strength for
                                                  texture and detail enhancement */
    hi_u16 edge_str[ISP_SHARPEN_GAIN_NUM];     /* RW; range: [0, 4095]; Format:7.5;Directional sharpen strength for
                                                  edge enhancement */
    hi_u16 texture_freq;         /* RW; range: [0, 4095];Format:6.6; Texture frequency adjustment.
                                    Texture and detail will be finer when it increase */
    hi_u16 edge_freq;            /* RW; range: [0, 4095];Format:6.6; Edge frequency adjustment.
    ...
    hi_u8  over_shoot;           /* RW; range: [0, 127]; Format:7.0;u8OvershootAmt */
    hi_u8  under_shoot;          /* RW; range: [0, 127]; Format:7.0;u8UndershootAmt */
    hi_u8  shoot_sup_str;        /* RW; range: [0, 255]; Format:8.0;overshoot and undershoot suppression strength,
                                    the amplitude and width of shoot will be decrease when shootSupSt increase */

    hi_u8   nr_lsc_ratio;                     /* RW;Range:[0x0, 0xff];Format:8.0; Strength of reserving the random
                                                 noise according to luma,
                                                 Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 not support */
    hi_u16  coarse_str[ISP_BAYER_CHN_NUM];    /* RW;Range:[0x0, 0x3ff];Format:10.0;
                                                 Coarse Strength of noise reduction */
    hi_u8   wdr_frame_str[WDR_MAX_FRAME_NUM]; /* RW;Range:[0x0, 0x50];Format:7.0;
                                                 Coarse strength of each frame in wdr mode */
    hi_u8   chroma_str[ISP_BAYER_CHN_NUM];  /* RW;Range:[0x0, 0x3];Format:2.0;Strength of Chrmoa noise reduction for
                                               R/Gr/Gb/B channel, Hi3516CV500/Hi3516DV300/Hi3516AV300/Hi3559V200/
                                              Hi3556V200/Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 not support */
    ...
    hi_u16 drc_strength_actual;  /* RW;Range: Hi3559AV100 = [0x0, 0xFF] | Hi3519AV100 = [0x0, 0x3FF] |
                                    Hi3516CV500 = [0x0, 0x3FF]| Hi3516DV300 = [0x0, 0x3FF]| Hi3516AV300 = [0x0, 0x3FF]|
                                    Hi3559V200 = [0x0, 0x3FF]| Hi3556V200 = [0x0, 0x3FF]| Hi3516EV200 = [0x0, 0x3FF]|
                                    Hi3516EV300 = [0x0, 0x3FF]|Hi3518EV300 = [0x0, 0x3FF]|Hi3516DV200 = [0x0, 0x3FF];
                                    Strength of dynamic range compression.
                                    Higher values lead to higher differential gain between shadows and highlights. */
    hi_u32 wdr_exp_ratio_actual[WDR_MAX_FRAME_NUM - 1]; /* RW; Range:[0x40, 0x4000]; Format:26.6; 0x40 means 1 times.
                                                           When enExpRatioType is OP_TYPE_AUTO, u32ExpRatio is invalid.
                                                           When enExpRatioType is OP_TYPE_MANUAL, u32ExpRatio is
    ...
    hi_u16  bl_actual[ISP_BAYER_CHN_NUM]; /* RW; Range: [0x0, 0xFFF];Format:12.0;
...
typedef struct {
    ...
    hi_u16  x;   /* RW; Range: Hi3559AV100 = [0, 8192 - 256]|Hi3519AV100 = [0, 8192 - 256]|
                    Hi3516CV500 = [0, 4608 - 256]|Hi3516DV300 = [0, 4608 - 256]| Hi3516AV300 = [0, 4608 - 256]|
                    Hi3559V200   = [0, 4608 - 256]|Hi3556V200  = [0, 4608 - 256]| Hi3516EV200 = [0,3072 - 256]|
                    Hi3516EV300 = [0,3072 - 256]|Hi3518EV300 = [0,3072 - 256]|Hi3516DV200 = [0,3072 - 256];
                    Format:13.0;AE image crop start x, limited range:[0, ImageWidth - 256] */
    hi_u16  y;   /* RW; Range: Hi3559AV100 = [0, 8192 - 120]|Hi3519AV100 = [0, 8192 - 120]|
                    Hi3516CV500 = [0, 4608 - 120]|Hi3516DV300 = [0, 4608 - 120]| Hi3516AV300 = [0, 4608 - 120]|
                    Hi3559V200   = [0, 4608 - 120]|Hi3556V200   = [0, 4608 - 120]| Hi3516EV200 = [0,3072 - 120]|
                    Hi3516EV300 = [0,3072 - 120]|Hi3518EV300 = [0,3072 - 120]| Hi3516DV200 = [0,3072 - 120];
                    Format:13.0;AEimage crop start y, limited range:[0, ImageHeight - 120]  */
    hi_u16  w;   /* RW; Range: Hi3559AV100 = [256, 8192]|Hi3519AV100 = [256, 8192]|Hi3516CV500 = [256, 4608]|
                    Hi3516DV300 = [256, 4608] | Hi3516AV300 = [256, 4608] |Hi3559V200   = [256, 4608]|
                    Hi3556V200  = [256, 4608]| Hi3516EV200 = [256, 3072]|Hi3516EV300 = [256, 3072]|
                    Hi3518EV300 = [256, 3072]|Hi3516DV200 = [256, 3072];
                    Format:14.0;AE image crop width,  limited range:[256, ImageWidth] */
    hi_u16  h;   /* RW; Range: Hi3559AV100 = [120, 8192]|Hi3519AV100 = [120, 8192]|Hi3516CV500 = [120, 4608]|
                    Hi3516DV300 = [120, 4608] | Hi3516AV300 = [120, 4608] |Hi3559V200   = [120, 4608]|
                    Hi3556V200  = [120, 4608]| Hi3516EV200 = [120, 3072]|Hi3516EV300 = [120, 3072]|
                    Hi3518EV300 = [120, 3072]|Hi3516DV200 = [120, 3072];
...
typedef ISP_TUNNEL_TYPE_E hi_isp_tunnel_type;
typedef struct {
    hi_bool  enable;
    hi_bool  available;
    hi_u32   tunnel_area_ratio;
    hi_u32   tunnel_exp_perf;
} hi_isp_tunnel_roi;

typedef struct {
    hi_isp_tunnel_roi  roi[TUNNEL_CLASS_MAX];
} hi_isp_tunnel_info;
...
typedef struct {
    ...
    hi_u16  x;    /* RW; Range: Hi3559AV100 = [0, 7936]|Hi3519AV100 = [0, 7936]|Hi3516CV500 = [0, 4352]|
                     Hi3516DV300 = [0, 4352]| Hi3516AV300 = [0, 4352]|Hi3559V200 = [0, 4352]|
                     Hi3556V200  = [0, 4352]|Hi3516EV200 = [0, 2816]|Hi3516EV300 = [0, 2816]|
                     Hi3518EV300 = [0, 2816]|Hi3516DV200 = [0, 2816];
                     Format:13.0;AF image crop start x, limited range:[0, ImageWidth-256] */
    hi_u16  y;    /* RW; Range: Hi3559AV100 = [0, 8072]|Hi3519AV100 = [0, 8072]|Hi3516CV500 = [0, 4488]|
                     Hi3516DV300 = [0, 4488]| Hi3516AV300 = [0, 4488]|Hi3559V200 = [0, 4488]|
                     Hi3556V200  = [0, 4488]|Hi3516EV200 = [0, 2952]|Hi3516EV300 = [0,2952]|
                     Hi3518EV300 = [0,2952]|Hi3516DV200 = [0,2952];
                     Format:13.0;AF image crop start y, limited range:[0, ImageHeight-120] */
    hi_u16  w;    /* RW; Range: Hi3559AV100 = [256, 8192]|Hi3519AV100 = [256, 8192]|Hi3516CV500 = [256, 4608]|
                     Hi3516DV300 = [256, 4608]| Hi3516AV300 = [256, 4608]| Hi3559V200  = [256, 4608]|
                     Hi3556V200  = [256, 4608]Hi3516EV200 = [256, 3072]|
                     Hi3516EV300 = [256, 3072]|Hi3518EV300 = [256, 3072]|Hi3516DV200 = [256, 3072];
                     Format:14.0;AF image crop width, limited range:[256, ImageWidth] */
    hi_u16  h;    /* RW; Range: Hi3559AV100 = [120, 8192]|Hi3519AV100 = [120, 8192]|Hi3516CV500 = [120, 4608]|
                     Hi3516DV300 = [120, 4608]| Hi3516AV300 = [120, 4608]| Hi3559V200  = [120, 4608]|
                     Hi3556V200  = [120, 4608]Hi3516EV200 = [120,3072]|
                     Hi3516EV300 = [120,3072]|Hi3518EV300 = [120, 3072]|Hi3516DV200 = [120, 3072];
...
typedef struct {
    ...
    hi_u8               gamma_value;      /* RW; Range: Hi3559AV100 = [0x0, 0x6] | Hi3519AV100 = [0x0, 0x6] |
                                             Hi3516CV500 = [0x0, 0x6] | Hi3516DV300 = [0x0, 0x6]|
                                             Hi3516AV300 = [0x0, 0x6]|Hi3559V200 = [0x0, 0x6]|
                                             Hi3556V200  = [0x0, 0x6]|Hi3516EV200 = [0x0, 0x1]|Hi3516EV300 = [0x0, 0x1]|
                                             Hi3518EV300 = [0x0, 0x1]|Hi3516DV200 = [0x0, 0x1]; */
...
typedef struct {
    ...
    hi_u16                  h_size;     /* RW; Range: Hi3559AV100 = [256, 8192]|Hi3519AV100 = [256, 8192]|
                                           Hi3516CV500 = [256, 4608]|Hi3516DV300 = [256, 4608]|
                                           Hi3516AV300 = [256, 4608]|Hi3559V200 = [256, 4608]|
                                           Hi3556V200  = [256, 4608]|Hi3516EV200 = [256,3072]|
                                           Hi3516EV300 = [256,3072]|Hi3518EV300 = [256,3072]|Hi3516DV200 = [256,3072];
                                           limited Range: [256, ImageWidth],AF image width. */
    hi_u16                  v_size;    /* RW; Range: Hi3559AV100 = [120, 8192]|Hi3519AV100 = [120, 8192]|
                                          Hi3516CV500 = [120, 4608]|Hi3516DV300 = [120, 4608]|
                                          Hi3516AV300 = [120, 4608]|Hi3559V200 = [120, 4608]|
                                          Hi3556V200  = [120, 4608]|Hi3516EV200 = [120,3072]|Hi3516EV300 = [120,3072]|
                                          Hi3518EV300 = [120,3072]|Hi3516DV200 = [120,3072];
...
typedef struct {
    ...
    hi_u8            iir_shift;               /* RW; Range: [0, 63]; IIR Shift.Only used for Hi3559AV100/Hi3519AV100 */
...
typedef union {
    ...
    struct {
        ...
        hi_u64  bit1_fe_ae_sti_glo_stat  : 1 ;   /* [2] .Only used for Hi3559AV100/Hi3519AV100 */
        hi_u64  bit1_fe_ae_sti_loc_stat  : 1 ;   /* [3] .Only used for Hi3559AV100/Hi3519AV100 */
        hi_u64  bit1_be_ae_glo_stat      : 1 ;   /* [4] */
        hi_u64  bit1_be_ae_loc_stat      : 1 ;   /* [5] */
        hi_u64  bit1_be_ae_sti_glo_stat  : 1 ;   /* [6] .Only used for Hi3559AV100/Hi3519AV100 */
        hi_u64  bit1_be_ae_sti_loc_stat  : 1 ;   /* [7] .Only used for Hi3559AV100/Hi3519AV100 */
        hi_u64  bit1_awb_stat1           : 1 ;   /* [8] */
        hi_u64  bit1_awb_stat2           : 1 ;   /* [9] */
        hi_u64  bit2_rsv0                : 2 ;   /* [10:11] */
        hi_u64  bit1_fe_af_stat          : 1 ;   /* [12] .Only used for Hi3559AV100/Hi3519AV100 */
...
typedef struct {
    hi_u32 fe_hist1024_value[ISP_CHN_MAX_NUM][HIST_NUM];  /* R; Range: [0x0, 0xFFFFFFFF]; Format:32.0;
                                                             Global 1024 bins histogram of FE */
    hi_u16 fe_global_avg[ISP_CHN_MAX_NUM][BAYER_PATTERN_NUM]; /* R; Range: [0x0, 0xFFFF]; Format:16.0;
                                                                 Global average value of FE,
                                                         Not support Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
    hi_u16 fe_zone_avg[ISP_CHN_MAX_NUM][AE_ZONE_ROW][AE_ZONE_COLUMN][BAYER_PATTERN_NUM]; /* R; Range: [0x0, 0xFFFF];
                                                                                            Format:16.0;
                                                                                            Zone average value of FE,
                              Not support for Hi3516CV500/ Hi3516DV300/Hi3516AV300/ Hi3559V200/Hi3556V200's Fe1 and Fe3,
                              Not support Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
    hi_u32 be_hist1024_value[HIST_NUM];                                 /* R; Range: [0x0, 0xFFFFFFFF]; Format:32.0;
                                                                           Global 1024 bins histogram of BE */
    hi_u16 be_global_avg[BAYER_PATTERN_NUM];                            /* R; Range: [0x0, 0xFFFF]; Format:16.0;
                                                                           Global average value of BE */
    hi_u16 be_zone_avg[AE_ZONE_ROW][AE_ZONE_COLUMN][BAYER_PATTERN_NUM]; /* R; Range: [0x0, 0xFFFF]; Format:16.0;
...
typedef struct {
    ...
    hi_u16 fe_global_avg[ISP_CHN_MAX_NUM][BAYER_PATTERN_NUM]; /* R; Range: [0x0, 0xFFFF]; Format:16.0;
                                                                 Global average value of FE. */
    hi_u16 fe_zone_avg[VI_MAX_PIPE_NUM][ISP_CHN_MAX_NUM][AE_ZONE_ROW][AE_ZONE_COLUMN][BAYER_PATTERN_NUM]; /* R;
    ...
    hi_u16 be_zone_avg[VI_MAX_PIPE_NUM][AE_ZONE_ROW][AE_ZONE_COLUMN][BAYER_PATTERN_NUM]; /* R; Range: [0x0, 0xFFFF];
                                                                                            Format:16.0;
                                                                                            Zone average value of BE */
} hi_isp_ae_stitch_statistics;

typedef struct {
    hi_u16 au16_zone_avg[MG_ZONE_ROW][MG_ZONE_COLUMN][BAYER_PATTERN_NUM]; /* R; Range: [0x0, 0xFF]; Format:8.0;
                                                                             Zone average value */
...
typedef struct {
    ...
    hi_u16  x;    /* RW; Range: Hi3559AV100 = [0, 8192 - 60]|Hi3519AV100 = [0, 8192 - 60]|Hi3516CV500 = [0, 4608 - 60]|
                     Hi3516DV300 = [0, 4608 - 60]| Hi3516AV300 = [0, 4608 - 60]|Hi3559V200   = [0, 4608 - 60]|
                     Hi3556V200 = [0, 4608 - 60]| Hi3516EV200 = [0,3072 - 60]|Hi3516EV300 = [0,3072 - 60]|
                     Hi3518EV300 = [0,3072 - 60]|Hi3516DV200 = [0,3072 - 60];
                     Format:13.0;AWB image crop start x, limited range:[0, ImageWidth - u16ZoneCol * 60] */
    hi_u16  y;    /* RW; Range: Hi3559AV100 = [0, 8192 - 14]|Hi3519AV100 = [0, 8192 - 14]|Hi3516CV500 = [0, 4608 - 14]|
                     Hi3516DV300 = [0, 4608 - 14]| Hi3516AV300 = [0, 4608 - 14]|Hi3559V200   = [0, 4608 - 14]|
                     Hi3556V200   = [0, 4608 - 14]| Hi3516EV200 = [0,3072-14]|Hi3516EV300 = [0,3072-14]|
                     Hi3518EV300 = [0,3072-14]|Hi3516DV200 = [0,3072-14];
                     Format:13.0;AWB image crop start y,limited range:[0, ImageHeight - u16ZoneRow * 14] */
    hi_u16  w;    /* RW; Range: Hi3559AV100 = [60, 8192]|Hi3519AV100 = [60, 8192]|Hi3516CV500 = [60, 4608]|
                     Hi3516DV300 = [60, 4608] | Hi3516AV300 = [60, 4608] |Hi3559V200 = [60, 4608]|
                     Hi3556V200 = [60, 4608]| Hi3516EV200 = [60,3072]|Hi3516EV300 = [60,3072]|Hi3518EV300 = [60,3072]|
                     Hi3516DV200 = [60,3072]; Format:14.0;
                     AWB image crop width, limited range:[u16ZoneCol * 60, ImageWidth] */
    hi_u16  h;    /* RW; Range: Hi3559AV100 = [14, 8192]|Hi3519AV100 = [14, 8192]|Hi3516CV500 = [14, 4608]|
                     Hi3516DV300 = [14, 4608] | Hi3516AV300 = [14, 4608] |Hi3559V200 = [14, 4608]|
                     Hi3556V200 = [14, 4608] | Hi3516EV200 = [14,3072]|Hi3516EV300 = [14,3072]|Hi3518EV300 = [14,3072]|
                     Hi3516DV200 = [14,3072]; Format:14.0;
...
typedef struct {
    ...
    hi_u16 zone_bin;           /* RW; Range:Hi3559AV100 = [1, 4] | Hi3519AV100 = [1, 4] | Hi3516CV500 = [1, 1]|
                                  Hi3516DV300 = [1, 1]| Hi3516AV300 = [1, 1]|Hi3559V200 = [1, 1]|Hi3556V200 = [1, 1]|
                                  Hi3516EV200 = [1,1]|Hi3516EV300 = [1,1]|Hi3518EV300 = [1,1]|Hi3516DV200 = [1,1];
                                  Brightness Bins */
    hi_u16 hist_bin_thresh[AWB_ZONE_BIN_MAX]; /* RW; Range: [0x0, 0xFFFF]; Bin Threshold */
...
typedef struct {
    ...
    hi_u16  zone_count_all[AWB_ZONE_STITCH_MAX]; /* R; Range: [0x0, 0xFFFF];
...
typedef struct {
    hi_isp_fe_focus_statistics  fe_af_stat; /* only used for Hi3559AV100/Hi3519AV100 */
    hi_isp_be_focus_statistics  be_af_stat;
    hi_isp_focus_grid_info      fe_af_grid_info; /* only used for Hi3559AV100/Hi3519AV100 */
...
typedef struct {
    ...
    hi_isp_focus_statistics_cfg focus_cfg;
...
typedef struct {
    ...
    hi_u16 step_fno_table[AI_MAX_STEP_FNO_NUM];  /* RW; Range:[1, 1024]; Format:16.0; Step-F number mapping table.
...
typedef struct {
    ...
    hi_u32  ae_hist1024_value[HIST_NUM]; /* R; Range:[0x0, 0xFFFFFFFF]; Format:32.0;
...
typedef struct {
    hi_isp_op_type exp_ratio_type;   /* RW; Range:[0, 1]; Format:1.0;
                                        OP_TYPE_AUTO: The ExpRatio used in ISP is generated by firmware;
                                        OP_TYPE_MANUAL: The ExpRatio used in ISP is set by u32ExpRatio */
    hi_u32 exp_ratio[EXP_RATIO_NUM]; /* RW; Range:[0x40, 0xFFF]; Format:26.6; 0x40 means 1 times.
                                        When enExpRatioType is OP_TYPE_AUTO, u32ExpRatio is invalid.
                                        When enExpRatioType is OP_TYPE_MANUAL, u32ExpRatio is quotient of
                                        long exposure time / short exposure time. */
    hi_u32 exp_ratio_max;           /* RW; Range:[0x40, 0x4000]; Format:26.6; 0x40 means 1 times.
                                       When enExpRatioType is OP_TYPE_AUTO, u32ExpRatioMax is max(upper limit) of
    ...
    hi_u32 exp_ratio_min;          /* RW; Range:[0x40, 0x4000]; Format:26.6; limited Range:[0x40, u32ExpRatioMax],
                                      0x40 means 1 times.
                                      When enExpRatioType is OP_TYPE_AUTO, u32ExpRatioMin is min(lower limit) of
                                      ExpRatio generated by firmware.
...
typedef struct {
    hi_isp_op_type exp_hdr_lv_type;   /* RW; Range:[0, 1]; Format:1.0;
                                         OP_TYPE_AUTO: The ExpHDRLv used in ISP is generated by firmware;
                                         OP_TYPE_MANUAL: The ExpHDRLv used in ISP is set by u32ExpHDRLv */
    hi_u32 exp_hdr_lv;             /* RW; Range:[0x40, 0x400]; Format:26.6; 0x40 means 1 times.
                                      ...
                                      When enExpHDRLvType is OP_TYPE_MANUAL, u32ExpHDRLv is the quotient of
                                      exposure / linear exposure. */
    hi_u32 exp_hdr_lv_max;         /* RW; Range:[0x40, 0x400]; Format:26.6; 0x40 means 1 times.
                                      When enExpHDRLvType is OP_TYPE_AUTO, u32ExpHDRLvMax is max(upper limit) of
    ...
    hi_u32 exp_hdr_lv_min;         /* RW; Range:[0x40, 0x400]; Format:26.6; limited range:[0x40, u32ExpHDRLvMax],
                                      0x40 means 1 times.
                                      When enExpHDRLvType is OP_TYPE_AUTO, u32ExpHDRLvMin is min(lower limit) of
                                      ExpHDRLv generated by firmware.
...
typedef struct {
    ...
    hi_isp_op_type smart_exp_type;  /* RW; Range:[0, 1]; Format:1.0;
                                       OP_TYPE_AUTO: The ExpCoef used in ISP is  generated by firmware;
                                       OP_TYPE_MANUAL: The ExpCoef used in ISP is set by u32ExpCoef */
    ...
    hi_u16  exp_coef_max;         /* RW; Range:[0x0, 0xFFFF]; Format:6.10; 0x400 means 1 times.
                                     When enExpHDRLvType is OP_TYPE_AUTO, u32ExpCoefvMax is max(upper limit) of ExpCoef
    ...
    hi_u16  exp_coef_min;         /* RW; Range:[0x0, 0xFFFF]; Format:6.10; 0x400 means 1 times.
                                     When enExpHDRLvType is OP_TYPE_AUTO, u32ExpCoefMax is min(lower limit) of ExpCoef
                                     generated by firmware.
...
typedef struct {
    ...
    hi_u16 low_stop;           /* RW;Format:16.0;limited range:(0, u16LowStart),
                                  4500K is recommend, should be smaller than u8LowStart */
    hi_u16 high_start;         /* RW;Format:16.0;limited range:(u16LowStart, 0xFFFF],
                                  6500K is recommend, shoule be larger than u8LowStart */
    hi_u16 high_stop;          /* RW;Format:16.0;limited range:(u16HighStart, 0xFFFF],
...
typedef struct {
    ...
    hi_u8   hist_thresh[AWB_LUM_HIST_NUM]; /* RW; Range:[0x0, 0xFF]; Format:8.0;
                                              In manual mode, user define luma thresh, thresh[0] is 0,
                                              thresh[5] is 0xFF,  thresh[i] greater or equal to  thresh[i-1] */
    hi_u16  hist_wt[AWB_LUM_HIST_NUM];     /* RW; Range:[0x0, 0xFFFF]; Format:16.0;
...
typedef struct {
    ...
    hi_bool multi_light_source_en;           /* RW; Range:[0, 1]; Format:1.0; If enabled, awb will do special process
                                                in multi light source enviroment */
    ...
    hi_u16  multi_ls_scaler;                 /* RW; Range:[0x0, 0x100]; Format:12.0;
                                                ...
                                                in ccm type, it means the strenght of multi process. */
    hi_u16  multi_ct_bin[AWB_MULTI_CT_NUM];  /* RW; Range:[0, 0XFFFF]; Format:16.0;
                                                AWB Support divide the color temperature range by 8 bins */
    hi_u16  multi_ct_wt[AWB_MULTI_CT_NUM];   /* RW; Range:[0x0, 0x400];Weight for different color temperature,
...
typedef struct {
    ...
    hi_s32 curve_para[AWB_CURVE_PARA_NUM]; /* RW; Format:32.0;Calibration Information,
...
typedef struct {
    hi_s16    r_gain; /* RW;Range:[-32768, 32767]; RgainValue(16bit) */
    hi_s16    b_gain; /* RW;Range:[-32768, 32767]; BgainValue(16bit) */
} hi_isp_speckcwbs16;

typedef struct {
    hi_s16    bv;          /* RW;Range:[-32768, 32767]; The center value of the Bv value targeted by this table. */
    hi_u8     fact_tbl[SPECAWB_FACTTBL_SIZE][SPECAWB_FACTTBL_SIZE];  /* RW;Range:[0, 0xFF]; Weight for light source
                                                                        detection. */
} hi_isp_spec_awb_facttbl_element;

typedef struct {
    hi_isp_speckcwb     wb_center;        /* RW;WB gain value at the center of the table: The table index is calculated
                                             as a relative value from this gain. */
    ...
    hi_isp_speckcwb     log_fact;         /* RW;Range covered by the table: 1/exp(stLogFact) to exp(stLogFact).
                                             For example, if it is 1.0, WBDelta will be 1/e to e.
                                             However, e = 2.71828 ... (base of natural logarithm) */
    hi_s32              limit_fact_min;   /* RW;Range:[0, s32LimitFactMax];AWB statics threshold value:
                                             minimum threshold value of ratio to pixel maximum value. */
    hi_s32              limit_fact_max;   /* RW;Range:[s32LimitFactMin, 0xFFFF];AWB statics threshold value:
                                             maximum threshold value of ratio to pixel maximum value. */
    hi_s32              limit_fact_limit; /* RW;Range:[0x600, 0x4000];AWB statics limit value:
                                             ratio to (pixel maximum value * s32LimitFactMax) */
    hi_s32              fact_offset;      /* RW;Range:[0, 0x800];
                                             The offset value of the weight when calculating the AWB statics. */
    hi_s32              b_fact;           /* RW;Range:[0x399, 0x500];
                                             The value of specular weight when calculating the AWB statics. */
    hi_s32              a_cnt_min;        /* RW;Range:[0, 0x20];Threshold for block adoption.
                                             If the integrated value of the AWB statics is less than m_ACntMin,
                                             the block is ignored. */
    hi_isp_speckcwb     wb_neutral;       /* RW;WB gain returned when AWB calculation can not be performed. */
    hi_u8               last_is_flash;    /* RW;Range:[1]: The last table is used for flash.
                                             0: Used for unknown Bv value. */
    hi_s16              bv_flash_e_limit; /* RW;Range:[-32768, 32767];Threshold of Bv value before strobe lighting when
                                             using table for strobe. If bLastIsFlash == TRUE and the Bv value before
                                             strobe flash is less than this value, use the table for strobe. */
    hi_s32              a_percent;        /* RW;Range:[0, 100];A value percent of the WB statics */
    hi_isp_speckcwbs16  wb_cnv_tbl[SPECAWB_FACTTBL_SIZE][SPECAWB_FACTTBL_SIZE]; /* RW; WB gain conversion table
                                                                             (incomplete chromatic adaptation table) */
...
typedef struct {
    ...
    hi_s16 blend_low_bv_thr;           /* RW; Range: [-32768, blend_high_bv_thr);
                                          Low Bv threshold for inner blending function */
...
typedef struct {
    ...
    hi_u8 cfa_plane_color[CFACOLORPLANE];       /* RO;Format:8.0; Indicate the planer numbers of raw data;
...
typedef struct {
    ...
    hi_isp_dng_srational color_matrix1[CCM_MATRIX_SIZE];       /* defines a transformation matrix that converts XYZ
                                                                  values to reference camera native color space values,
                                                                  under the first calibration illuminant. */
    hi_isp_dng_srational color_matrix2[CCM_MATRIX_SIZE];       /* defines a transformation matrix that converts XYZ
                                                                  values to reference camera native color space values,
                                                                  under the second calibration illuminant. */
    hi_isp_dng_srational camera_calibration1[CCM_MATRIX_SIZE]; /* defines a calibration matrix that transforms reference
                                                                  camera native space values to individual camera native
                                                                  space values under the first calibration illuminant */
    hi_isp_dng_srational camera_calibration2[CCM_MATRIX_SIZE]; /* defines a calibration matrix that transforms reference
                                                                 camera native space values to individual camera native
                                                                 space values under the second calibration illuminant */
    hi_isp_dng_srational forwad_matrix1[CCM_MATRIX_SIZE];      /* defines a matrix that maps white balanced camera
                                                                  colors to XYZ D50 colors */
    hi_isp_dng_srational forwad_matrix2[CCM_MATRIX_SIZE];      /* defines a matrix that maps white balanced camera
                                                                  colors to XYZ D50 colors */

    hi_u8  calibration_illuminant1;      /* RO;Format:8.0;Light source, actually this means white balance setting.
    ...
    hi_u8  calibration_illuminant2;      /* RO;Format:8.0;Light source, actually this means white balance setting.
                                            '0' means unknown, '1' daylight, '2' fluorescent, '3' tungsten, '10' flash,
                                            '17' standard light A, '18' standard light B, '19' standard light C,
                                            '20' D55, '21' D65, '22' D75, '255' other */
...
typedef struct {
    ...
    hi_isp_dng_wb_gain wb_gain2; /* the calibration White balance gain of colorcheker in high colortemper
                                    light source */
