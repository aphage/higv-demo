...
* Description: ive common header file
...
/*
* Definition of the IVE_MEM_INFO_S.This struct special purpose for input or ouput,
* such as Hist, CCL, ShiTomasi.
*/
...
typedef enum hiIVE_BLOB_TYPE_E {
    ...
    /* When blob type is YVU420SP, channel = 3 */
    IVE_BLOB_TYPE_YVU420SP = 0x2,
    /* When blob type is YVU422SP, channel = 3 */
