 ...
 * Description: chip specific configure data structure of rc
...
typedef struct hiVENC_H264_CVBR_S {
    ...
    HI_U32      u32ShortTermStatTime;       /* RW; Range:[1, 120]; the long-term rate statistic time,
                                                the unit is second (s) */
    HI_U32      u32LongTermStatTime;        /* RW; Range:[1, 1440]; the long-term rate statistic time,
                                                the unit is u32LongTermStatTimeUnit */
    HI_U32      u32LongTermMaxBitrate ;     /* RW; Range:[2, 614400]; the long-term target max bitrate,
                                                can not be larger than u32MaxBitRate, the unit is kbps */
    HI_U32      u32LongTermMinBitrate ;     /* RW; Range:[0, 614400];the long-term target min bitrate,
                                                can not be larger than u32LongTermMaxBitrate, the unit is kbps */
} VENC_H264_CVBR_S;
...
typedef struct hiVENC_PARAM_H264_CBR_S {
    ...
    HI_U32  u32MaxIprop;                /* RW; Range:[1, 100]; the max ratio of i frame and p frame,
                                            can not be smaller than u32MinIprop */
...
typedef struct hiVENC_PARAM_H264_VBR_S {
    HI_S32  s32ChangePos;               /* RW; Range:[50, 100]; Indicates the ratio of the current bit rate to
...
typedef struct hiVENC_PARAM_H264_AVBR_S {
    ...
    HI_U32  u32MaxStillQP;              /* RW; Range:[0, 51]; the max QP value of I frame for still scene, can not be
                                            smaller than u32MinIQp and can not be larger than su32MaxIQp */
    ...
    HI_U32  u32MaxIQp;                  /* RW; Range:[0, 51]; the max I qp */
    HI_U32  u32MinIQp;                  /* RW; Range:[0, 51]; the min I qp, can not be larger than u32MaxIQp */
    HI_U32  u32MinQpDelta;              /* RW; Range:[0, 4];Difference between FrameLevelMinQp and MinQp,
...
typedef struct hiVENC_PARAM_H264_QVBR_S {
    ...
    HI_S32  s32PsnrFluctuateUL;        /* RW; Range:[18, 40]; Reduce the target bitrate
                                            when the value of psnr approch the upper limit */
    HI_S32  s32PsnrFluctuateLL;        /* RW; Range:[18, 40]; Increase the target bitrate when the value of psnr
                                            approch the lower limit, can not be larger than s32PsnrFluctuateUL */
...
typedef struct hiVENC_PARAM_H264_CVBR_S {
    ...
    HI_U32  u32MinQpDelta;              /* RW; Range:[0, 4]; Difference between FrameLevelMinQp and MinQp,
                                            FrameLevelMinQp = MinQp(or MinIQp) + MinQpDelta */
    HI_U32  u32MaxQpDelta;              /* RW; Range:[0, 4]; Difference between FrameLevelMaxQp and MaxQp,
                                            FrameLevelMaxQp = MaxQp(or MaxIQp) - MaxQpDelta */

    HI_U32  u32ExtraBitPercent;         /* RW; Range:[0, 1000]; the extra bits that can be allocated
                                            when the actual bitrate goes above the target bitrate */
    HI_U32  u32LongTermStatTimeUnit;    /* RW; Range:[1, 1800]; the time unit of LongTermStatTime,
...
typedef struct hiVENC_PARAM_MJPEG_CBR_S {
    ...
    HI_U32  u32MinQfactor;               /* RW; Range:[1, 99]; the min Qfactor value,
                                            can not be larger than u32MaxQfactor */
} VENC_PARAM_MJPEG_CBR_S;

/* The param of mjpege vbr */
typedef struct hiVENC_PARAM_MJPEG_VBR_S {
    HI_S32 s32ChangePos;                 /* RW; Range:[50, 100]; Indicates the ratio of the current bit rate to
                                            the maximum bit rate when the Qfactor value starts to be adjusted */
...
typedef struct hiVENC_PARAM_H265_VBR_S {
    HI_S32  s32ChangePos;               /* RW; Range:[50, 100]; Indicates the ratio of the current bit rate
    ...
    HI_U32  u32MaxIprop;                /* RW; [1, 100]the max ratio of i frame and p frame,
                                            can not be smaller than u32MinIprop */
    HI_S32  s32MaxReEncodeTimes;        /* RW; Range:[0, 3]; Range:max number of re-encode times */
...
typedef struct hiVENC_PARAM_H265_CVBR_S {
    ...
    HI_U32  u32ExtraBitPercent;         /* RW; Range:[0, 1000]; the extra ratio of bitrate that can be allocated
...
typedef struct hiVENC_RC_PARAM_S {
    HI_U32 u32ThrdI[RC_TEXTURE_THR_SIZE];   /* RW; Range:[0, 255]; Mad threshold for controlling
                                                the macroblock-level bit rate of I frames */
    HI_U32 u32ThrdP[RC_TEXTURE_THR_SIZE];   /* RW; Range:[0, 255]; Mad threshold for controlling
                                                the macroblock-level bit rate of P frames */
    HI_U32 u32ThrdB[RC_TEXTURE_THR_SIZE];   /* RW; Range:[0, 255]; Mad threshold for controlling
                                                the macroblock-level bit rate of B frames */
    HI_U32 u32DirectionThrd;                /* RW; Range:[0, 16]; The direction for controlling
                                                the macroblock-level bit rate */
    HI_U32 u32RowQpDelta;                   /* RW; Range:[0, 10]; the start QP value of each macroblock row
...
typedef struct hiVENC_FRAMELOST_S {
    HI_BOOL                bFrmLostOpen;          /* RW; Range:[0, 1];Indicates whether to discard frames to
                                                    ensure stable bit rate when the instant bit rate is exceeded */
...
typedef struct hiVENC_SUPERFRAME_CFG_S {
    ...
    HI_U32                u32SuperIFrmBitsThr;     /* RW; Range:[0, 4294967295];Indicate the threshold of the super
                                                        I frame for enabling the super frame processing mode */
    HI_U32                u32SuperPFrmBitsThr;     /* RW; Range:[0, 4294967295];Indicate the threshold of the super
                                                        P frame for enabling the super frame processing mode */
    HI_U32                u32SuperBFrmBitsThr;     /* RW; Range:[0, 4294967295];Indicate the threshold of the super
                                                        B frame for enabling the super frame processing mode */
